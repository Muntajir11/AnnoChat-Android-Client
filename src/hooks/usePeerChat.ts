    ...
    onFrame((msg) => {
      switch (msg.t) {
        ...
        case 'matched':
          ...
          setConnectFailed(false);
          setChatError(null);
          setRoomId(String(msg.d.roomId));
          setRole(msg.d.role as 'caller' | 'callee');
          setMessages([]);
          setPeerTyping(false);
          setTransport('none');
          ...
          break;
        case 'signal':
          void peerRef.current?.accept(msg.d.kind as 'offer' | 'answer' | 'ice', msg.d.payload);
          break;
        case 'relay-enabled':
          setTransport('relay');
          setConnectFailed(false);
          break;
        case 'relay-message':
          setMessages((m) => [...m, { id: nextMsgId('r'), text: String(msg.d.text), sender: 'stranger' }]);
          break;
        case 'relay-typing':
          setPeerTyping(Boolean(msg.d.isTyping));
          break;
        case 'peer-left':
          setMatched(false);
          setSearching(false);
          ...
          break;
        case 'error': {
          setChatError(String(msg.d.message));
          const next = effectsForError(String(msg.d.code));
